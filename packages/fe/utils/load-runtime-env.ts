...
/**
 * @returns Env file paths in ascending precedence order for direct Nuxt startup.
 */
export const resolveFrontendEnvFilePaths = (): readonly string[] =>
  [
 ...
 * @returns void
 */
export const loadFrontendRuntimeEnv = ({
  runtimeEnv = process.env,
  envFilePaths = resolveFrontendEnvFilePaths(),
}: {
